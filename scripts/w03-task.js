...
// arrow functions are always unnamed, this step needs clarification
...
function selectionFunction() {
    ...
    console.log(document.querySelector('#subtotal').value)
    console.log(document.querySelector('#member').checked)
...
document.querySelector('#getTotal').addEventListener('click', selectionFunction);
